...
let contractAddress = "0x424bEf71D42A6404CD65aC026A23008FE0292F50";
let contractAbi = [
    {
      "inputs": [
        {
...
const connectMetamask = async() => {
    ...
    element.innerHTML = "Student has successfully logged in.<br><br><br>Student Id - " + WALLET_CONNECTED;
}
...
const addVote = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        var cand = document.getElementById("cand");
        cand.innerHTML = "Please Login first";      //connect metamask first
    }
}
...
const getAllCandidates = async() => {
    if(WALLET_CONNECTED != 0) {
        ...
        var p3 = document.getElementById("p3");
        p3.innerHTML = "Please login first";    //connect metamask first
    }
}